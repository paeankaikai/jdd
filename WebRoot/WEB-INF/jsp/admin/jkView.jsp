...
.import_listtableT .listtableTS2 {
	width: 275px;
}

.import_listtableT .listtableTS3 {
	width: 120px;
}

import_listtable .import_listtableT {
	background: #FFFFFF;
}

.import_listtable .import_listtableT span {
	font-size: 14px;
	color: #666666;
	font-weight: normal;
}

.import_listtableBody .import_listtableT span {
	font-size: 12px;
}
...
.import_listtableT .listtableTS7 {
	width: 120px;
}
...
<body>
	<div class="import_detail">
		<table style="text-align: left">
			<tr height="30">
				...
				<td id="status"><c:if test="${release.ststus eq 0 }">
						...
						<span class="yellowcolor">已驳回</span>
					</c:if></td>
			</tr>
			<tr height="30">
			...
			<tr height="30">
				<td>审批文件: <a href="/admin/release/uploadFilePath?filePath=${release.excelPath }">${release.excelPath }</a>
		...
		<div class="import_listtable">
			<p class="import_listtableT" style="background:#FFFFFF">
				<span class="listtableTS1">序号</span>
				<span class="listtableTS2">员工ID</span>
				<span class="listtableTS3">姓名</span>
				<span class="listtableTS3">公司</span>
				<span class="listtableTS4">数量</span>
			</p>
...
<script>
	$(function() {
		...
		$("#back").click(function() {
			if (${admin} == 1)
				window.location.href = "/admin/release/checkRelease?type=1";
			else
		...
		function makeHtml(num) {
			...
			for (var i = (num - 1) * 10, j = 0; i < list.length && j < 10; i++, j++) {
				...
				html += "<div class='import_listtableBody'>" + "<p class='import_listtableT'>"
						...
						+ "<span class='listtableTS2'>" + detail[2] + "</span>"
						+ "<span class='listtableTS3'>" + detail[3] + "</span>"
						+ "<span class='listtableTS3'>" + detail[5] + "</span>"
						+ "<span class='listtableTS4'>" + detail[4] + "</span>" + "</p></div>";
			}
		...
		$("#insert").click(function() {
			$.post("/admin/release/checkJkView", {
