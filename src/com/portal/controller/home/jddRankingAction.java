...
@Controller
@RequestMapping("/home/jddRanking/")
public class jddRankingAction {
	...
	public ModelAndView jddRanking(ModelAndView model) {
		//什么也不干，只是一个跳转
		model.addObject("page", "jddRanking");
		model.setViewName("/home/jddRanking");
		return model;
	}
	 ...
	 * 吉点点达人榜
	 */
	@RequestMapping("jddRankingPage.do")
	@ResponseBody
	public Map<String, Object> jddRankingPage(HttpServletRequest request, HttpServletResponse response,ModelAndView model,
			@RequestParam(value="page", defaultValue="1") String page,
			@RequestParam(value="rows", defaultValue="10") String rows) {
		Map<String, Object> data = new HashMap<String, Object>();
		PageInfo<JddAccount> pageRows = jddAccountService.queryPageNum(Integer.parseInt(page), Integer.parseInt(rows),  new JddAccount() ,null);
